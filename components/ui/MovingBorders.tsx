...
export function Button({
  ...
  children,
  as: Component = "button", // Change here
  containerClassName,
  borderClassName,
  duration,
  className,
  ...
  as?: React.ElementType; // Correct typing
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 rounded-[1.75rem]" // Fix typo in class
...
export const MovingBorder = ({
  ...
  const pathRef = useRef<SVGRectElement>(null); // Fix typing here
